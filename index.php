...
<main>';
	...
	else if ($menu == 9) { include("logout.php"); }

	
	print '
</main>
<footer>
<p>Copyright &copy; 2023 Goran Roso<a href="https://github.com/fanaticcro97/Projektni-zadatak-PHP"><img src="images/GitHub-Mark-Light-32px.png" title="Github" alt="Github"></a></p>
</footer>
</body>
</html>';
?>